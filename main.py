...
# Opening(cv2.MORPH_OPEN) : remove small noise, erodes the white regions and then dilates them
# Dilation(cv2.MORPH_DIlATE) : expands the white regions, helps connect nearby white pixels and fill gaps
